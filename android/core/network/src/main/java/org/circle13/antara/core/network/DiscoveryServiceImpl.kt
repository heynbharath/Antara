...
class DiscoveryServiceImpl(
    ...
    override fun startAdvertising(token: ByteArray, capabilities: Int) {
        ...
        // Wrap dynamic token inside Service Data of our UUID
    ...
    override fun startScanning(): Flow<DiscoveredPeerEvent> = callbackFlow {
        val scanner = bluetoothAdapter?.bluetoothLeScanner ?: return@callbackFlow
                    ...
                    if (serviceData != null) {
                        trySend(
                            DiscoveredPeerEvent(
                                ...
                                deviceCapabilities = 0, // Default capabilities mapping
